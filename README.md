...
Built by Joshua Stoneman – US Navy veteran, Loxone Silver Partner, ForgeFrost inventor.  
...
3. Open `thermal_sim.ipynb` in VS Code or Jupyter
4. Run cells in order
5. Customize params in `simulate_classical()` with your prototype data

## Business Impact
- Builder quotes: "Quantum-simulated freeze protection: X hours buffer before 32°F"
- Loxone upsell: "38% energy savings potential with mini-split integration"
- Financing & showroom: Screenshot-ready R&D proof
